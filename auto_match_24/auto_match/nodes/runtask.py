...
class ArmAction:
    ...
    def drop1(self, check=False):
        ...
        global cube1_list0
        # 默认放置位置
        self.robot.step_go2(0.13)
        rospy.sleep(1.8)
        x = self.x_kb[0] * (cube1_list0[0][1][1]-17) + self.x_kb[1]
        ...
        if cube_list0 != []:
            ...
            while True:
                if cube_list0 == []:
                    ...
                    cube_list3 = cube_list0
                    cube_list3 = sorted(cube_list3, key=lambda x: x[1][0], reverse=True)
                    if cube_list3[0][1][1] < 220 or cube_list3[0][1][1] > 270:
                        if cube_list3[0][1][1] < 220:
                            print("前进")
