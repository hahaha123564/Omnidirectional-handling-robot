...
def cube_list_callback(data):
    ...
    return cube_list
def cube_list_callback1(data):
    global cube1_list
    global cube1_list0
    cube1_list = []  # Çå¿Õ cube_list
    
    for obj in data.detections:
        obj_id = obj.results[0].id
        obj_pose = [obj.results[0].pose.pose.position.x, obj.results[0].pose.pose.position.y, obj.results[0].pose.pose.position.z]
        cube1_list.append([obj_id, obj_pose])

    #print(cube_list)
    cube1_list0 = cube1_list
    return cube1_list
...
class ArmAction:
    ...
    def detectorB(self):
        ...
        while True:
            ...
            if cube_list4 == []:
                break        
            print(66666666)      
            if cube_list4[0][1][1] < 100 :
                    print("前进")
                    self.robot.step_go2(0.07)
                    rospy.sleep(1.5)
                    if self.stop_flag: return
            elif cube_list4[0][1][1] < 190 or cube_list4[0][1][1] > 340:
                if cube_list4[0][1][1] < 190:
                    print("前进")
                    self.robot.step_go2(0.03)
                    rospy.sleep(1.5)
                    if self.stop_flag: return
                elif cube_list4[0][1][1] > 340:
                    print("后退")
    ...
    def detectorend2(self):
        ...
        while True:
            if cube_list0 == []:
                ...
                cube_list1 = cube_list0
                cube_list1 = sorted(cube_list1, key=lambda y: y[1][1], reverse=True)
                if cube_list1[0][1][1] < 100 :
                        print("前进")
                        self.robot.step_go2(0.07)
                        rospy.sleep(1.5)
                        if self.stop_flag: return
                elif cube_list1[0][1][1] < 180 or cube_list1[0][1][1] > 310:
                    if cube_list1[0][1][1] < 180:
                        print("前进")
                        self.robot.step_go2(0.03)
                        rospy.sleep(1.5)
                        if self.stop_flag: return
                    elif cube_list1[0][1][1] > 310:
                        print("后退")
                        self.robot.step_back()
                        rospy.sleep(1.5)
                        if self.stop_flag: return
    ...
    def grasp(self,name):
        ...
        #rospy.sleep(1)rostopic pub /task_start_flag std_msgs/String "data: 'true'" -1 >/dev/null  python3 detect3.py
    ...
    def drop1(self, check=False):
        ...
        x = self.x_kb[0] * (cube1_list0[0][1][1]-5) + self.x_kb[1]
        y = self.y_kb[0] * (cube1_list0[0][1][0]-5) + self.y_kb[1]
        z = -13
        self.interface.set_pose(x, y, z)
        rospy.sleep(0.5)
    ...
    def drop(self, check=False):
        ...
        return True
    def drop4(self, check=False):
        '''
        放置方块, 可以先s判断是否有方块, 从而调整放置高度
        @param check: 是否判断有无方块, 默认判断
        @return item_id: 执行结果
        '''
        r1 = rospy.Rate(0.25)
    ...
    def drop2(self, check=False):
        ...
        z = 66
        cube_list3 = []
        self.robot.step_go2(0.08)
        rospy.sleep(1.0)
        self.interface.set_pose(250, 0, -20)
        global cube_list0
        if cube_list0 != []:
            #rospy.sleep(1)
            ...
            while True:
                if cube_list0 == []:
                    ...
                    if cube_list3[0][1][1] < 240 or cube_list3[0][1][1] > 320:
                        if cube_list3[0][1][1] < 240:
                            print("前进")
                            self.robot.step_go1()
                            rospy.sleep(1)
                            if self.stop_flag: return
                        elif cube_list3[0][1][1] > 320:
                            print("后退")
                            self.robot.step_back()
                            rospy.sleep(1)
                            if self.stop_flag: return
            ...
            cube_list3 = sorted(cube_list3, key=lambda x: x[1][0], reverse=True)
            if len(cube_list3) > 0:
                x = self.x_kb[0] * (cube_list3[0][1][1] - 10) + self.x_kb[1]
        ...
        if cube_list0 != []:
            ...
            while True:
                if cube_list0 == []:
                    ...
                    cube_list3 = cube_list0
                    cube_list3 = sorted(cube_list3, key=lambda x: x[1][0], reverse=True)
                    if cube_list3[0][1][1] < 190 or cube_list3[0][1][1] > 270:
                        if cube_list3[0][1][1] < 190:
                            print("前进")
                            self.robot.step_go2(0.005)
                            rospy.sleep(1.7)
                            if self.stop_flag: return
                        elif cube_list3[0][1][1] > 270:
                            print("后退")
                            self.robot.step_back()
                            rospy.sleep(1.7)
                            if self.stop_flag: return
            ...
            if len(cube_list3) > 0:
                ...
                y = self.y_kb[0] * (cube_list3[0][1][0] - 5)+ self.y_kb[1]
                z = 170
                cube_list3 = []
    ...
    def arm_home(self, block=False):
        ...
        收起机械臂(无物品)
        '''
        self.interface.set_pose(130, 180, 160)
        if block:
            rospy.sleep(0.5)
...
class AutoAction:
    ...
    def yiC(self):
        ...
        if self.stop_flag: return 
    def yiD(self):
        self.robot.step_turn(-110)
        if self.stop_flag: return
        self.robot.step_go(0.55)
        if self.stop_flag: return 
    def sanD(self):
        ...
        if self.stop_flag: return 
    def Bqi(self):
        self.robot.step_turn(170)
        if self.stop_flag: return
        self.robot.step_go(0.45)
        if self.stop_flag: return 
    def Bwu(self):
        self.robot.step_turn(-170)
        if self.stop_flag: return
        ...
        if self.stop_flag: return 
    def Dqi(self):
        self.robot.step_turn(-136)
        if self.stop_flag: return
        self.robot.step_go(1.9)
        if self.stop_flag: return 
        self.robot.step_turn(-45)
        if self.stop_flag: return 
        self.robot.step_go(0.2)
        if self.stop_flag: return
    def Bsan(self):
        self.robot.step_turn(-143)
        if self.stop_flag: return
        self.robot.step_go(1.9)
        if self.stop_flag: return 
        self.robot.step_turn(-45)
    ...
    def Cyi(self):
        self.robot.step_turn(-120)
        if self.stop_flag: return
        self.robot.step_go(1.3)
        if self.stop_flag: return 
    def Byi(self):
        self.robot.step_turn(160)
        if self.stop_flag: return
        self.robot.step_go(1.4)
        if self.stop_flag: return 
        self.robot.step_turn(80)
        if self.stop_flag: return
    ...
    def run_task(self):
        ...
        while b != 0:
            ...
            self.arm.arm_grasp_ready()  # 移动机械臂到其他地方
            if x==1:
                self.robot.step_back1(0.05)  # 后退
            if x==2:
                self.robot.step_back1(0.08)  # 后退
            self.robot.step_turn(95)
            if self.stop_flag: return
            self.robot.step_go(0.4)
            self.robot.step_turn(-70)
            if x == 1:
                self.arm.drop()  # 放下物品
                self.arm.arm_grasp_ready()  # 移动机械臂到其他地方
            if x == 2: 
        ...
        self.robot.step_go(0.9)
        if self.stop_flag: return    
        ret = self.robot.goto_local('Collection_B')
        if self.stop_flag: return
        self.arm.drop2()  # 放下物品
#在san点抓D    
        b = 0
...
##在一点识别D
        ...
        while b > 0 and yi != 1:
            ...
            if b != 0:
                print("返回yi点")
                self.Bwu()
                ret = self.robot.goto_local("yi") # 根据抓到的物品类型，导航到对应的放置区
                if self.stop_flag: return  
            else:
                self.Bqi()
                ret = self.robot.goto_local("san") # 根据抓到的物品类型，导航到对应的放置区
                if self.stop_flag: return  
##若没有D则顺路抓C    
...
#在wu点抓C  
        ...
        while b > 0 and wu != 1:
            ...
            if wu != 1:
                ...
                print("返回wu点")
                self.Byi()
                ret = self.robot.goto_local("qi") # 根据抓到的物品类型，导航到对应的放置区
                if self.stop_flag: return     
#在wu点抓B     
        b = 0
        a = 0 
...
#在qi点抓D
        ...
        if b != 0:
            while b>0:      
                ...
                item_type = self.arm.detectorend1()
                if item_type[0][0] == object_list[0][0]:
                    self.arm.grasp(item_type)  # ץȡ��Ʒ������ץȡ��Ʒ������
                    print("========�����һ��===== ")
                    self.robot.step_back()  # ����
                    if self.stop_flag: return
                    self.arm.arm_grasp_ready()  
                    self.yiC()
                    ret = self.robot.goto_local("Collection_B") # ?��?Y������?��????������D����?��?o?��???��|��?��?????
                    # self.robot.step_go1()
                    if self.stop_flag: return        
                    if ret:
                        if d == 0:
                            ...
                            self.arm.drop()  # ������Ʒ
                        self.robot.step_back1()  # o����?
                        self.arm.arm_grasp_ready()  # ��??��?��D�̡�?��?????��?��?
                        if self.stop_flag: return
                    else:
                        rospy.logerr("task error: navigation to the drop_place fails")
                        if d == 0:
                            ...
                            self.arm.drop()  # ������Ʒ
                        self.robot.step_back1()  # ����
                        self.arm.arm_grasp_ready()  # �ƶ���е�۵������ط�
                ...
                if item_type[0][0] == object_list[1][0]:
                    ...
                    self.yiD()
                    if self.stop_flag: return    
                    ret = self.robot.goto_local("Collection_C") # ?��?Y������?��????������D����?��?o?��???��|��?��?????
                    # self.robot.step_go1()
                    if self.stop_flag: return        
                    if ret:
                        if e == 0:
                ...
                if item_type[0][0] == object_list[2][0]:
                    ...
                    self.arm.arm_grasp_ready()   
                    self.sanD()   
                    ret = self.robot.goto_local("Collection_D") # ?��?Y������?��????������D����?��?o?��???��|��?��?????
                    # self.robot.step_go1()
                    if self.stop_flag: return        
                    if ret:
                        if f == 0:
        ...
        #             self.arm.grasp(item_type)  # 抓取物品并返回抓取物品的类型
        #             print("========向后退一点===== ")
        #             self.robot.step_back()  # 后
        #             if self.stop_flag: return
        #             self.arm.arm_grasp_ready()  
        #             ret = self.robot.goto_local("ba") # ¸ù¾Ý×¥µ½µÄÎïÆ·ÀàÐÍ£¬µ¼º½µ½¶ÔÓ¦µÄ·ÅÖÃÇø
        #             #rospy.sleep(2) # Í£ÎÈ
        #             if self.stop_flag: return              
        #             ret = self.robot.goto_local("Collection_B") # ¸ù¾Ý×¥µ½µÄÎïÆ·ÀàÐÍ£¬µ¼º½µ½¶ÔÓ¦µÄ·ÅÖÃÇø
        #             self.robot.step_go1(0.02)
        #             if self.stop_flag: return        
        #             if ret:
        #                 if d == 0:
        ...
        #                 self.arm.arm_grasp_ready()  # 移动机械臂到其他地方
        #             if self.stop_flag: return 
        #         ret = self.robot.goto_local("zhongjiandian")
        #         if self.stop_flag: return   
        #         self.robot.step_go1(0.1)
        #         if self.stop_flag: return   
        #         b = b - 1
        ...
        #         if self.stop_flag: return                           
        #         sorting_time += 1
        #     elif item_type == object_list[1][0]:
        #         self.arm.arm_grasp_ready()
        #         print("========前往放置区===== ")
        #         ret = self.robot.goto_local('er')
        #         rospy.sleep(1)
        #         if self.stop_flag: return
        #         ret = self.robot.goto_local('Collection_C')
        #         rospy.sleep(1)
        #         if self.stop_flag: return
        #         if ret:
        #             self.arm.drop()  # 放下物品
        ...
        #         if self.stop_flag: return                                
        #         sorting_time += 1
        #     elif item_type == object_list[2][0]:
        #         self.arm.arm_grasp_ready()
        #         print("========前往放置区===== ")
        #         ret = self.robot.goto_local('Collection_D')
        #         #rospy.sleep(1)
        #         if self.stop_flag: return
        #         if ret:
        #             self.arm.drop()  # 放下物品
        ...
        # ret = self.robot.goto_local('zhongjiandian')# 将1位置往前挪一点
        # if self.stop_flag: return
        # #rospy.sleep(1)
        # if self.stop_flag: return
        # sorting_time = 0
        ...
        #         if self.stop_flag: return
        #         sorting_time += 1
        # ret = self.robot.goto_local('zhongjiandian1')  # 将1位置往前挪一点
        # rospy.sleep(1)
        # if self.stop_flag: return
        # sorting_time = 0
        # while sorting_time < 3:
...
if __name__ == '__main__':
    try:
        ...
        rospy.Subscriber("/objects1", Detection2DArray, cube_list_callback1,queue_size=1)
        AutoAction()
        rospy.spin()
