        ...
        while True:
            ...
            if cube_list4 == []:
                ...
                if cube_list4[0][1][0] < 140:
                    ...
                    cube_list4 = []
                    if self.stop_flag: return  
            # elif cube_list4[0][1][1] < 220 or cube_list4[0][1][1] > 270:
            #     if cube_list4[0][1][1] < 220:
            #         print("前进")
            #         self.robot.step_go1()
            #         rospy.sleep(2)
            #         cube_list2 = []
        ...
        while True:
            ...
            if cube_list4 == []:
                ...
                if cube_list4[0][1][0] < 140:
                    ...
                    cube_list4 = []
                    if self.stop_flag: return  
            # elif cube_list4[0][1][1] < 220 or cube_list4[0][1][1] > 260:
            #     if cube_list4[0][1][1] < 220:
            #         print("前进")
            #         self.robot.step_go1()
            #         rospy.sleep(2)
