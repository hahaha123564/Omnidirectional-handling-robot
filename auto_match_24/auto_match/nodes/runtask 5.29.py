...
class ArmAction:
    ...
    def grasp(self,name):
        ...
        #print(cube_list1)
        # 获取机械臂目标位置
        x = self.x_kb[0] * (name[0][1][1] - 10)+ self.x_kb[1]
    ...
    def drop2(self, check=False):
        ...
        if cube_list0 != []:
            ...
            while True:
                ...
                if cube_list3[0][1][1] < 200 or cube_list3[0][1][1] > 310:
                    if cube_list3[0][1][1] < 200:
                        print("前进")
                        self.robot.step_go1(0.005)
                        rospy.sleep(0.5)
                        if self.stop_flag: return
...
##在一点识别B
        ...
        while b > 0 :
            ...
            print("========前往放置区===== ")
            ret = self.robot.goto_local("ba") # 根据抓到的物品类型，导航到对应的放置区
            #rospy.sleep(2) # 停稳
            if self.stop_flag: return  
