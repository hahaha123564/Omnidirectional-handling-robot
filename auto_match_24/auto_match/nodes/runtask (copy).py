...
class ArmAction:
    ...
    def detectorD(self):
        ...
        while True:
            ...
            cube_list4 = sorted(cube_list4, key=lambda x: x[1][0], reverse=False)
            if cube_list4 == []:
                break      
            elif cube_list4[0][1][0] < 140 or cube_list4[0][1][0] > 508:  
                if cube_list4[0][1][0] < 140:
                    print("前进")
                    self.robot.step_turn(10)
                    rospy.sleep(2)
                    cube_list2 = []
                    cube_list4 = []
                    if self.stop_flag: return
                    ...
                    cube_list4 = []
                    if self.stop_flag: return  
            elif cube_list4[0][1][1] < 240 or cube_list4[0][1][1] > 270:
    ...
    def drop3(self, check=False):
        ...
        if cube_list0 != []:
            ...
            while True:
                cube_list3 = cube_list0
                cube_list3 = sorted(cube_list3, key=lambda x: x[1][0], reverse=True)
                if cube_list3[0][1][1] < 240 or cube_list3[0][1][1] > 270:
                    if cube_list3[0][1][1] < 240:
                        self.robot.step_go1()
                        rospy.sleep(1)
                        if self.stop_flag: return
