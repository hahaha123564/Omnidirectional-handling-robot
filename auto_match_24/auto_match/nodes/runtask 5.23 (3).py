...
class ArmAction:
    ...
    def detectorD(self):
        ...
        while True:
            ...
            if cube_list4[0][1][1] < 270 or cube_list4[0][1][1] > 328:
                if cube_list4[0][1][1] < 270:
                    print("前进")
                    self.robot.step_go1(0.005)
                    cube_list2 = []
                    cube_list4 = []
                    if self.stop_flag: return
                elif cube_list4[0][1][1] > 328:
                    print("后退")
    ...
    def detectorend1(self):
        ...
        while True:
            cube_list1 = cube_list0
            cube_list1 = sorted(cube_list1, key=lambda x: x[1][0], reverse=True)
            if cube_list1[0][1][1] < 270 or cube_list1[0][1][1] > 328:
                if cube_list1[0][1][1] < 270:
                    print("前进")
                    self.robot.step_go1(0.005)
                    if self.stop_flag: return
                elif cube_list1[0][1][1] > 328:
                    print("后退")
                    self.robot.step_back()
                    if self.stop_flag: return
            else:
    ...
    def grasp(self,name):
        ...
        #print(cube_list1)
        # 获取机械臂目标位置
        x = self.x_kb[0] * (name[0][1][1] - 15)+ self.x_kb[1]
