...
class ArmAction:
    ...
    def detectorD(self):
        ...
        for i in range(len(cube_list1)):
            if cube_list1[i][1][1] - cube_list1[i+1][1][1] < 47:
    ...
    def drop3(self, check=False):
        ...
        if cube_list0 != []:
            ...
            cube_list3 = sorted(cube_list3, key=lambda x: x[1][0], reverse=True)
            if len(cube_list3) > 0:
                x = self.x_kb[0] * (cube_list3[0][1][1]+15) + self.x_kb[1]
                y = self.y_kb[0] * cube_list3[0][1][0] + self.y_kb[1]
                z = 158
...
class RobotMoveAction:
    ...
    def rotate_left(self, degrees):
        ...
        goal = common.msg.TurnBodyDegreeGoal(
            ...
            type=common.msg.TurnBodyDegreeGoal.TYPE_ODOM,

            turn_degrees=degrees,

        )

        self.turn_action_cli.send_goal_and_wait(goal, rospy.Duration.from_sec(5))  # 超过5s为超时
    ...
    def rotate_right(self, degrees):
        ...
        goal = common.msg.TurnBodyDegreeGoal(
            ...
            turn_degrees=-degrees,  # 使用负值表示向右旋转
