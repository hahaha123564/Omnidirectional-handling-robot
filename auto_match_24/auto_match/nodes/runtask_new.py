#!/usr/bin/python3
        ...
        # if self.stop_flag: return   D到san
        ...
        # if self.stop_flag: return  D到yi
import rospyrostopic pub /task_start_flag std_msgs/String "data: 'true'" -1 >/dev/null
import rospkg
import actionlib
...
class ArmAction:
    ...
    def grasp(self):
        ...
        #print(cube_list1)
        # 获取机械臂目标位置
        x = self.x_kb[0] * (cube_list1[0][1][1])+ self.x_kb[1]
        y = self.y_kb[0] * (cube_list1[0][1][0]) + self.y_kb[1]
        z = -55
